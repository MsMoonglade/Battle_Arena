...
/////// Diffuse:
                ...
                float3 diffuseColor = lerp((float3(0.4926471,0.4926471,0.4926471)+_t_alb_var.rgb),_Color_player.rgb,_Mask_ID_var.r);
